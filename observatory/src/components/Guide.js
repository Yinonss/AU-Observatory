...
return (
    <div className='container'>
        <p>
            In order to conduct an astronamical research with AU Observatory Planner you will have to be familiarwith  the 
    ...
    <p>
        ...
        2. Enter a target name - click on the search button to get the right assention and declenation.
        3. Set starting and ending dats for the plan.
        4. Set at least one imaging session.
        5. Optional: add an advanced setting to the plan.
        6. Click on 'Add' and notice that the target has been added to the plan list.
        7. Repeat this process (from step 1 to 6) for every target that is nessesary for the research.
        8. Optional: add a bias or dark frame to reset photons for reducing image noise.
        9. Optional: add advanced setting to the whole plan.
        10. Click submit.
    </p>
</div>
    );
